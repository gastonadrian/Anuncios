...
namespace Anuncios.Web.Controllers
{
    public class RouteRegistrar
    {
        public static void RegisterRoutesTo(RouteCollection routes)
        {
            ...
            //routes.CreateArea("Organization/Department", "Anuncios.Web.Controllers.Organization.Department",
            ...
            //);
            //routes.CreateArea("Organization", "Anuncios.Web.Controllers.Organization",
            ...
            routes.CreateArea("Root", "Anuncios.Web.Controllers",
