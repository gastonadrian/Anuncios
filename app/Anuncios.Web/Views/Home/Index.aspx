...
<%@ Import Namespace="Anuncios.Web.Controllers" %>
    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within Anuncios.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within Anuncios.Data.NHibernateMaps.GetConventions() 
            ...
            <li>
                Open Anuncios.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                Anuncios.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
